...
| A1.2 solo con cuentas de seis meses o más | Rechazada: deja fuera a 33 de 89 cuentas, más de un tercio del churn, y esconde el límite de la fórmula en lugar de mostrarlo. |
...
## Adenda 1 (2026-09-08): el conteo de ventanas traslapadas es 33, no 30

Al implementar A1.2 sobre el dataset real, la regla "menos de seis meses de uso" marcó 33 cuentas: 30 con entre dos y cinco meses de uso y 3 sin ningún mes de uso. El 30 de la primera versión de este documento venía del prototipo, que dejaba fuera a las 3 cuentas sin uso porque su conteo de meses era nulo. La regla literal las incluye, y así queda: `windows_overlap` es verdadero para las 33, y las 3 sin uso además llevan `drop_status = no_usage`. La prueba sobre el dataset real fija el 33.
