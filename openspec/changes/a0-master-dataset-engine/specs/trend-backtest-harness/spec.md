...
### Requisito: reproducción de la comparación de fórmulas
...
#### Escenario: corrida completa del backtest
...
### Requisito: métricas reportadas por fórmula
...
#### Escenario: métricas de una fórmula
...
### Requisito: regresión del momentum ganador en k = 2
...
### Requisito: evidencia de fuga de datos en k = 0
...
#### Escenario: AUC cercano a 1.0 en k = 0
