...
### Requisito: comando único de construcción
...
### Requisito: idempotencia byte a byte
...
#### Escenario: dos corridas seguidas
...
#### Escenario: falta una base de datos
...
#### Escenario: falta una dependencia
...
### Requisito: carpeta de datos configurable
...
#### Escenario: carpeta de datos indicada
