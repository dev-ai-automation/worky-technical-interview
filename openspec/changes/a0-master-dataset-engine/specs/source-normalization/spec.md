...
### Requirement: normalización de fecha
...
#### Scenario: fecha ya en formato ISO
...
#### Scenario: mismo negocio con y sin subdominio
...
### Requirement: nombre normalizado de empresa
...
### Requirement: idempotencia de la normalización
...
#### Scenario: segunda normalización
...
### Requirement: codificación explícita de archivos
...
#### Scenario: archivo con caracteres acentuados
